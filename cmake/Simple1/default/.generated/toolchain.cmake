...
set(MP_AS "/Applications/microchip/xc8/v3.10/pic-as/bin/pic-as" CACHE PATH "Legacy variable from MPLAB X pointing to the assembler")
set(MP_AS_DIR "/Applications/microchip/xc8/v3.10/pic-as/bin" CACHE PATH "Legacy variable from MPLAB X pointing to the assembler base directory")
set(CMAKE_ASM_COMPILER "/Applications/microchip/xc8/v3.10/pic-as/bin/pic-as" CACHE FILEPATH "Path to the compiler binary.")

# Legacy variable from MPLAB X pointing to the assembler binary.
set(MP_AS ${CMAKE_ASM_COMPILER})

set(MP_LD "/Applications/microchip/xc8/v3.10/pic-as/bin/pic-as" CACHE FILEPATH "Legacy variable from MPLAB X pointing to the linker binary.")
set(MP_LD_DIR "/Applications/microchip/xc8/v3.10/pic-as/bin" CACHE PATH "Legacy variable from MPLAB X pointing to the linker base directory")

set(MP_AR "/Applications/microchip/xc8/v3.10/pic-as/bin/pic-as" CACHE FILEPATH "Legacy variable from MPLAB X pointing to the archiver binary.")
set(MP_AR_DIR "/Applications/microchip/xc8/v3.10/pic-as/bin" CACHE PATH "Legacy variable from MPLAB X pointing to the archiver base directory")

set(CMAKE_AR "/Applications/microchip/xc8/v3.10/pic-as/bin/pic-as" CACHE FILEPATH "Path to the archiver binary.")
